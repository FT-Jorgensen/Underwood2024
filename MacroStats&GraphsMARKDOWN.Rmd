...
ggplot(FinalDataFrameHABITAT,aes(x=reorder(SiteName,-FFGDiversity),y=FFGDiversity,fill=Restored))+geom_bar(stat="identity")+coord_flip()+xlab("Sampling Site")+ylab("FFG SHDI per site")+ggtitle("Macroinvertebrate functional feeding group SHDI per site")+theme_minimal()
